 ...
 */
package com.zly.deskclock.alarms;
...
public class AlarmService extends Service {
     ...
     * ALARM_DONE_ACTION).
     */
    public static final String ALARM_SNOOZE_ACTION = "com.zly.deskclock.ALARM_SNOOZE";
     ...
     */
    public static final String ALARM_DISMISS_ACTION = "com.zly.deskclock.ALARM_DISMISS";

    /** A public action sent by AlarmService when the alarm has started. */
    public static final String ALARM_ALERT_ACTION = "com.zly.deskclock.ALARM_ALERT";

    /** A public action sent by AlarmService when the alarm has stopped for any reason. */
    public static final String ALARM_DONE_ACTION = "com.zly.deskclock.ALARM_DONE";
