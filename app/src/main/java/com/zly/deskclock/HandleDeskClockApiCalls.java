...
import com.zly.deskclock.timer.TimerFullScreenFragment;
...
import com.zly.deskclock.worldclock.CityObj;
...
public class HandleDeskClockApiCalls extends Activity {
    ...
    private static final String ACTION_PREFIX = "com.zly.deskclock.action.";
    ...
    public static final String EXTRA_CITY = "com.zly.deskclock.extra.clock.CITY";
