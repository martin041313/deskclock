...
import com.zly.deskclock.BaseActivity;
import com.zly.deskclock.R;
import com.zly.deskclock.Utils;
import com.zly.deskclock.timer.TimerFullScreenFragment.OnEmptyListListener;
...
public class TimerAlertFullScreen extends BaseActivity implements OnEmptyListListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getFragment() == null) {
            com.zly.deskclock.timer.TimerFullScreenFragment timerFragment = new com.zly.deskclock.timer.TimerFullScreenFragment();

            // Create fragment and give it an argument to only show
            // timers in STATE_TIMESUP state
            Bundle args = new Bundle();
            args.putBoolean(com.zly.deskclock.timer.Timers.TIMESUP_MODE, true);
    ...
    protected void onNewIntent(Intent intent) {
        com.zly.deskclock.timer.TimerFullScreenFragment timerFragment = getFragment();
    ...
    public void onEmptyList() {
        if (com.zly.deskclock.timer.Timers.LOGGING) {
    ...
    private com.zly.deskclock.timer.TimerFullScreenFragment getFragment() {
        return (com.zly.deskclock.timer.TimerFullScreenFragment) getFragmentManager().findFragmentByTag(FRAGMENT);
    }
}
