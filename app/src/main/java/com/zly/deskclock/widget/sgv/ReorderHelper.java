...
package com.zly.deskclock.widget.sgv;

import android.graphics.Point;
import android.util.Log;
import android.view.View;

import com.zly.deskclock.widget.sgv.StaggeredGridView.LayoutParams;
import com.zly.deskclock.widget.sgv.StaggeredGridView.ReorderListener;
...
public final class ReorderHelper {
    ...
    private final com.zly.deskclock.widget.sgv.StaggeredGridView mParentView;

    private boolean mEnableUpdatesOnDrag = true;

    public ReorderHelper(ReorderListener listener, com.zly.deskclock.widget.sgv.StaggeredGridView parentView) {
