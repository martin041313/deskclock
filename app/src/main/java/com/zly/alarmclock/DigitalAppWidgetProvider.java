...
import com.zly.deskclock.alarms.AlarmStateManager;
import com.zly.deskclock.worldclock.Cities;
import com.zly.deskclock.worldclock.CitiesActivity;
...
public class DigitalAppWidgetProvider extends AppWidgetProvider {
     ...
     **/
    public static final String ACTION_ON_QUARTER_HOUR = "com.zly.deskclock.ON_QUARTER_HOUR";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (com.zly.alarmclock.DigitalAppWidgetService.LOGGING) {
        ...
        if (ACTION_ON_QUARTER_HOUR.equals(action)
            ...
            if (appWidgetManager != null) {
                ...
                for (int appWidgetId : appWidgetIds) {
                    ...
                    float ratio = com.zly.alarmclock.WidgetUtils.getScaleRatio(context, null, appWidgetId);
                    com.zly.alarmclock.WidgetUtils.setTimeFormat(context, widget, 0/*no am/pm*/, R.id.the_clock);
                    com.zly.alarmclock.WidgetUtils.setClockSize(context, widget, ratio);
    ...
    public void onAppWidgetOptionsChanged(Context context, AppWidgetManager appWidgetManager,
        ...
        float ratio = com.zly.alarmclock.WidgetUtils.getScaleRatio(context, newOptions, appWidgetId);
    ...
    private void updateClock(
        ...
        final Intent intent = new Intent(context, com.zly.alarmclock.DigitalAppWidgetService.class);
