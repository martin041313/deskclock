...
import com.zly.deskclock.worldclock.WorldClockAdapter;
...
public class DigitalWidgetViewsFactory implements RemoteViewsFactory {
    ...
    private class RemoteWorldClockAdapter extends WorldClockAdapter {
        ...
        private void updateView(RemoteViews clock, CityObj cityObj, int clockId,
            ...
            com.zly.alarmclock.WidgetUtils.setTimeFormat(mContext, clock, labelSize, clockId);
    ...
    @Override
    public int getCount() {
        if (com.zly.alarmclock.WidgetUtils.showList(mContext, mId, mFontScale)) {
    ...
    public void onDataSetChanged() {
        ...
        mFontScale = com.zly.alarmclock.WidgetUtils.getScaleRatio(mContext, null, mId);
    }
